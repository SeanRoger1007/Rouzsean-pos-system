...
public class Register {
	 ...
	 */
	public LineItem addItem(Product product, double quantity) {
		return addItem(product, quantity, false);
	}

	/**
	 * Add Product to Sale with piece support.
	 * @param product product to be added.
	 * @param quantity quantity.
	 * @param asPiece whether this is a piece sale.
	 * @return LineItem.
	 */
	public LineItem addItem(Product product, double quantity, boolean asPiece) {
		if (currentSale == null)
			initiateSale(DateTimeStrategy.getCurrentTime());

		LineItem lineItem = currentSale.addLineItem(product, quantity, asPiece);
	 ...
	 */
	public void updateItem(int saleId, LineItem lineItem, double quantity, double priceAtSale) {
	...
	/**
	 * Removes product from the current Sale if it exists.
	 * @param productId ID of product to be removed.
	 */
	public void removeProductFromCurrentSale(int productId) {
		if (currentSale != null) {
			List<LineItem> items = new java.util.ArrayList<LineItem>(currentSale.getAllLineItem());
