...
public class Stock {
	 ...
	 * @return
	 */
	public boolean addProductLot(String dateAdded, double quantity, Product product, double cost) {
	...
	/**
	 * Returns all ProductLots during a period.
	 * @param start start bound.
	 * @param end end bound.
	 * @return list of ProductLot.
	 */
	public List<ProductLot> getAllProductLotDuring(java.util.Calendar start, java.util.Calendar end) {
		return inventoryDao.getAllProductLotDuring(start, end);
	}
	...
	/**
	 * Returns Stock in inventory finds by id as double.
	 * @param id id of Stock.
	 * @return Stock in inventory finds by id.
	 */
	public double getStockSumDoubleById(int id) {
		return inventoryDao.getStockSumDoubleById(id);
	}
